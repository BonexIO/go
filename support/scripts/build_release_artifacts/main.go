...
func build(pkg, dest, version, buildOS, buildArch string) {
	...
	timeFlag := fmt.Sprintf("-X github.com/stivens13/go/support/app.buildTime=%s", buildTime)
	versionFlag := fmt.Sprintf("-X github.com/stivens13/go/support/app.version=%s", version)
...
func repoName() string {
	...
	return "github.com/stivens13/go"
