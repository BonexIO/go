...
const (
  ...
  AccountTypeOperator AccountType = 2
  AccountTypeNode AccountType = 3
  AccountTypeBrand AccountType = 4
  AccountTypeMerchant AccountType = 5
  AccountTypeFriendbot AccountType = 6
  AccountTypeClient AccountType = 7
)
var accountTypeMap = map[int32]string{
  0: "AccountTypeFoundation",
  1: "AccountTypeVendor",
  2: "AccountTypeOperator",
  3: "AccountTypeNode",
  4: "AccountTypeBrand",
  5: "AccountTypeMerchant",
  6: "AccountTypeFriendbot",
  7: "AccountTypeClient",
}
