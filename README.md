...
[![GoDoc](https://godoc.org/github.com/BonexIO/go?status.svg)](https://godoc.org/github.com/BonexIO/go)
[![Go Report Card](https://goreportcard.com/badge/github.com/BonexIO/go)](https://goreportcard.com/report/github.com/BonexIO/go)
...
You can use Glide yourself in your project and add stellar go as a vendor'd dependency, or you can just drop this repos as `$GOPATH/src/github.com/BonexIO/go` to import it the canonical way (you still need to run `glide install`).
...
In addition to the packages described above, this repository contains various packages related to working with the Stellar network from a go program.  It's recommended that you use [godoc](https://godoc.org/github.com/BonexIO/go#pkg-subdirectories) to browse the documentation for each.
