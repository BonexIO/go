...
1. Clone horizon's source:  `go get github.com/BonexIO/go && cd $GOPATH/src/github.com/BonexIO/go/`
2. Under the project folder, download external dependencies: `glide install`
3. Build the binary: `go install github.com/BonexIO/go/services/horizon`
