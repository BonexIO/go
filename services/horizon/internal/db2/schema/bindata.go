...
func migrations13_add_accounttype_fieldSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/13_add_accounttype_field.sql", size: 168, mode: os.FileMode(420), modTime: time.Unix(1531812812, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
